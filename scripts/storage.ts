...
export const SEARCH_ENGINE_PLACEHOLDER_COLOR = "search-engine-placeholder-color";
...
export const RSS_ACTIVE_COLOR = 'rss-active-color';
...
// Categories
export const CATEGORY_BG_COLOR = 'category-bg-color';
export const CATEGORY_TEXT_COLOR = 'category-text-color';
