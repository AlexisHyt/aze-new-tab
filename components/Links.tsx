...
import type { Category, Group, Link } from "~scripts/popup/settingsConfig"
...
export const Links = () => {
  ...
  const [links, setLinks] = useStorage(LINKS, [] as Link[]);
  const [categoryBackgroundColor] = useStorage(CATEGORY_BG_COLOR, CATEGORY_BG_COLOR__DEFAULT);
  const [categoryTextColor] = useStorage(CATEGORY_TEXT_COLOR, CATEGORY_TEXT_COLOR__DEFAULT);
  ...
  return (
    <Fragment>
      <Dialog open={isOpen} handler={handleOpen}>
        <DialogHeader>Create shortcut</DialogHeader>
        <DialogBody>
          <form
            ...
            <div
              ...
              <p
                ...
                style={{
                  ...
                  "--bg-color-hover": darkenColor(categoryBackgroundColor, 0.1),
