...
export function MyToast() {
  ...
  return (
    <div className={`fixed top-5 right-5 flex items-center gap-4 p-4 rounded shadow-lg ${getClassesAndIcon(type).classes} text-white text-md font-semibold transition-opacity duration-300 ${show ? "opacity-1" : "opacity-0"}`}>
